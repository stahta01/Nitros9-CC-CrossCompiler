...
dopragma (char *ln)
{
    ...
    {
        if (cflag)
            puts ("#2");             /* WZ - the addition of the semicolon assists c.comp from outputing asm prematurally */
        else
            printf ("#pragma asm "); /* WZ - the addition of the semicolon assists c.comp from outputing asm prematurally */
